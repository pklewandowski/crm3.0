...
$(document).ready(function () {
    ...
    $(document).on('click', '#saveMenu', function () {
        triggerAction(gSaveActionBtnHtml);
    });

    $(document).on('click', '#cancelMenu', function () {
        triggerAction(gCancelActionBtnHtml);
    });
...
// });
    ...
    $('#scheduleFilterModal #filter-btn').click(function (e) {
        refetchEvents();
    ...
    $(document).on('click', "#cancel_and_set-btn", function () {
        var schedule_form = $('form#schedule-form');
