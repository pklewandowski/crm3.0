...
class TestInstalmentSchedule:
    ...
    def test_instalment_schedule_no_product_start_date(self, fix_user):
        instalment_schedule = InstalmentSchedule(user=fix_user)
        ...
        assert len(instalment_list['list']) == 12
        assert instalment_list['list'][0][INSTALMENT_MATURITY_DATE_SELECTOR] == add_month(dt, 1)
    ...
    def test_instalment_schedule_no_product_custom_instalment_schedule_instalment_rate(self, fix_user):
        instalment_schedule = InstalmentSchedule(user=fix_user)
        instalment_count = len(custom_instalment_schedule)
        ...
        assert instalment_count == len(instalment_list['list'])
    ...
    def test_instalment_schedule_no_product_custom_instalment_schedule_change_flag(self, fix_user):
        ...
        assert instalment_count == len(instalment_list['list'])
        assert instalment_list['list'][1][INSTALMENT_TOTAL_SELECTOR] == 2300
        assert instalment_list['list'][2][INSTALMENT_TOTAL_SELECTOR] == 2950
