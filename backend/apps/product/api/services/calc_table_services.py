    ...
    columns.extend(
        [
            ...
            {"title": "Koszty", "columns":
                [
                    {
                        "title": "koszty utrzymania", "field": "cost_list.COST_MAINTENANCE",
                        "headerSort": False,
                        "dataType": "currency",
                        "hozAlign": "right",
                        "formatter": "moneyCss",
                    ...
                    {
                        "title": "kara umowna", "field": "cost_list.COST_CONTRACTUAL_PENALTY", "headerSort": False,
                        "dataType": "currency",
                        "hozAlign": "right",
                        "formatter": "moneyCss",
                        "formatterParams": {"decimal": ",", "thousand": " ", "precision": 2,
                    ...
                    {
                        "title": "opłata windykacyjna", "field": "cost_list.COST_VINDICATION_FEE", "headerSort": False,
                        "dataType": "currency",
                        "hozAlign": "right",
                        "formatter": "moneyCss",
                        "formatterParams": {"decimal": ",", "thousand": " ", "precision": 2,
                    ...
                    {
                        "title": "koszty inne", "field": "cost_list.COST_OTHER", "headerSort": False,
                        "dataType": "currency",
                        "hozAlign": "right",
                        "formatter": "moneyCss",
                        "formatterParams": {
