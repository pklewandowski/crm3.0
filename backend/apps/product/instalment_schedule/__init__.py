...
INSTALMENT_INTEREST_AGGREGATE = 'instalment_capital_aggregate'
INSTALMENT_COMMISSION_AGGREGATE = 'instalment_capital_aggregate'
INSTALMENT_TOTAL_AGGREGATE = 'instalment_capital_aggregate'
