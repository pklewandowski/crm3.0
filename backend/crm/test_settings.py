"""
Django settings for speedcash_crm project.
...
if os.name == 'nt':
    ...
    WKHTMLTOIMAGE_PATH = r'/usr/bin/wkhtmltoimage'
...
if os.name == 'nt':
    ...
    TESSERACT_EXECUTABLE_PATH = r'/usr/bin/tesseract'
